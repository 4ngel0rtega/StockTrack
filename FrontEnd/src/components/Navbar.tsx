        ...
        <nav className='bg-sky-900 sticky top-0 z-40'>
            <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
                <a href="" className='flex items-center space-x-3 rtl:space-x-reverse'>
                    ...
                    <span className='self-center text-2xl font-semibold whitespace-nowrap text-white'>StocTrack</span>
                </a>
                    ...
                    {isOpenUser && 
                        <div ref={userMenuRef} className='z-50 absolute top-full text-base list-none bg-white divide-y divide-sky-100 rounded-lg shadow-sm'>
                            <div className='px-4 py-3'>
                                <span className='block text-sm text-sky-900 font-bold'>Vanessa Enriquez</span>
                                <span className='block text-sm text-sky-900 truncate'>vanessa@gmail.com</span>
                            </div>
                            <ul className='py-2' aria-labelledby='user-menu'>
                                <li>
                                    <a href="" className='block px-4 py-2 text-sm text-gray-700 hover:bg-sky-100'>Dashboard</a>
                                    <a href="" className='block px-4 py-2 text-sm text-red-700 hover:bg-sky-100'>Cerrar Sesión</a>
                                </li>
                            </ul>
                        </div>
                    }
                ...
                <div className={`items-center justify-between ${isOpen ? 'flex' : 'hidden'} w-full md:flex md:w-auto md:order-1`}>
                    <ul className='flex w-full flex-col font-medium p-4 md:p-0 mt-4 border border-sky-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 '>
                        ...
                        <li>
                            <a href="" className='block py-2 px-3 text-white rounded-sm hover:bg-sky-100 hover:text-black md:hover:bg-transparent md:hover:text-sky-300 md:p-0'>Proyecto</a>
                        </li>
                        <li>
                            <a href="" className='block py-2 px-3 text-white rounded-sm hover:bg-sky-100 hover:text-black md:hover:bg-transparent md:hover:text-sky-300 md:p-0'>Equipo</a>
                        </li>
                    </ul>
                </div>
            </div>
